...
// append a paragraph node as a child of the current node
function appendNode() {
...
function remove() {
    if (currentNode.parentNode == document.body)
        alert("Cant remove a top-level element");
    else {
...
// a unique id and the gtiven text
